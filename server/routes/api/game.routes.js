...
const { getAllGames, getAllGamesByPlayerId, getAllGamesByTeamId, getAllGamesBySeasonId, getGameById, createGame, updateGameById, deleteGameById, } = require('../../controllers/game.controller');
