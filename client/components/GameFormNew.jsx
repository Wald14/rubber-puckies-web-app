...
import { getSeasons, getSeasonGames, getSeasonTeams, getTeamRoster, getAllGoalies, updateGame, getPuckieTeams } from '../utils/queries';
...
{(props.adminController === "createGameNew" || selectedGame) &&
<>
